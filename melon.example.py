import re
source='''
<tr class="lst50" id="lst50" data-song-no="30851703">
...
# artist = re.search(PATTERN_A_CONTENT, div_rank02).group(1)
# print(artist)
#
...
# album = re.search(PATTERN_A_CONTENT, div_rank03).group(1)
# print(album)
